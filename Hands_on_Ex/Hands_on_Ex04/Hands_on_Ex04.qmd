---
title: "Hands-on Exercise 03:  Spatial Weights and Applications"
...
This hands-on exercise is for how to compute spatial weights using R. By the end to this hands-on exercise, :
...
can display the complete weight matrix by using *str()*.
...
How to derive distance-based weight matrices by using [*dnearneigh()*](https://r-spatial.github.io/spdep/reference/dnearneigh.html) of **spdep** package.
